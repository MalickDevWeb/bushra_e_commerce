export default function SuperAdminConfigBoutiquePage() {
  return (
    <div className="flex flex-col gap-6 w-full text-[#e8e1d3] max-w-[1600px] mx-auto pb-10">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold font-serif text-[#d4af37]">Informations Boutique</h1>
          <p className="text-[13px] text-[#a89b82] mt-1">Données légales et paramètres globaux de l'entreprise</p>
        </div>
