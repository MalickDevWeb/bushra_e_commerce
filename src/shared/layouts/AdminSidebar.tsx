  ...
  return (
    <div className="flex h-full flex-col bg-[#090705] overflow-y-auto custom-scrollbar font-serif shadow-[inset_-1px_0_15px_rgba(212,175,55,0.03)] border-r border-[#d4af37]/20">
      ...
      <div className="flex-1 pb-10">
        ...
        <div className="border-b border-[#d4af37]/15 py-1">
          ...
          {open.boutique && (
            <div className="flex flex-col pb-1">
              ...
              {subLink("#", <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M6 4.25v15.5m6-15.5v15.5m6-15.5v15.5" /></svg>, "Collections")}
              {subLink("#", <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>, "Promotions")}
              {subLink("#", <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" /></svg>, "Stocks")}
            </div>
          )}
        </div>
        ...
        <div className="border-b border-[#d4af37]/15 py-1">
          ...
          {open.contenu && (
            <div className="flex flex-col pb-1">
              ...
              {subLink("#", <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M6 4.25v15.5m6-15.5v15.5m6-15.5v15.5" /></svg>, "Collections")}
              {subLink("#", <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931z" /></svg>, "À propos")}
              {subLink("#", <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" /></svg>, "Header / Menu")}
        ...
        <div className="border-b border-[#d4af37]/15 py-1">
          ...
          {open.parametres && (
            <div className="flex flex-col pb-1">
              ...
              {subLink("#", <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" /></svg>, "SEO")}
        ...
        {/* ══════════════════════════════════════ */}
        {/* SUPER ADMIN — Section exclusive */}
        {/* ══════════════════════════════════════ */}
        <div className="py-1">
          <button
            onClick={() => toggle("superadmin")}
            className="w-full flex items-center justify-between px-5 py-3 cursor-pointer group hover:bg-[#d4af37]/5 transition-colors"
          >
            <div className="flex items-center gap-3.5">
              {/* Crown icon */}
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5 text-[#d4af37] shrink-0">
                <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0l4.179 2.25L12 21.75 2.25 16.5l4.179-2.25m11.142 0l-5.571 3-5.571-3" />
              </svg>
              <span className="text-[15px] text-[#d4af37] tracking-wide group-hover:text-white transition-colors font-serif font-semibold">Super Admin</span>
            </div>
            <svg
              viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
              className={`w-3.5 h-3.5 text-[#d4af37] transition-transform duration-200 ${open.superadmin ? "rotate-180" : "rotate-0"}`}
            >
              <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
            </svg>
          </button>
          ...
          {open.superadmin && (
            <div className="flex flex-col pb-2">
              {/* Entrer dans la boutique — Exclusif Super Admin */}
              <Link
                href="/boutique"
                target="_blank"
                className="flex items-center gap-3 pl-[3.2rem] pr-5 py-2.5 hover:bg-[#d4af37]/10 transition-colors group border-b border-[#d4af37]/10 mb-1"
              >
                <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4 text-[#d4af37] shrink-0">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                </svg>
                <span className="text-[13.5px] text-[#e3c77d] group-hover:text-white tracking-wide font-serif">Entrer dans la boutique</span>
                <svg fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="w-3 h-3 text-[#d4af37] ml-auto shrink-0">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" />
                </svg>
              </Link>

              {/* Gestion des admins */}
              {subLink("/admin/super-admin",
                <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>,
                "Gestion des admins"
              )}
              {/* API & Intégrations — highlighted */}
              <Link
                href="#"
                className="flex items-center gap-3 pl-[3.2rem] pr-5 py-2.5 bg-[#d4af37]/15 hover:bg-[#d4af37]/20 transition-colors group"
              >
                <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4 text-[#d4af37] shrink-0">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 9.75L16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" />
                </svg>
                <span className="text-[13.5px] text-[#d4af37] group-hover:text-white tracking-wide font-serif font-medium">API & Intégrations</span>
              </Link>
              {/* Maintenance */}
              {subLink("#",
                <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-4 h-4">
