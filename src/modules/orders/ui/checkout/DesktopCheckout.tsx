...
export function DesktopCheckout({ onSubmit, isSubmitting, error }: DesktopCheckoutProps) {
              ...
              <div className="flex gap-12">
                ...
                <div className="flex-[1.5]">
                  <div className="rounded-2xl border border-[#d4af37]/30 bg-[#0c0a07] p-8">
                    ...
                    <form id="desktop-checkout-form" onSubmit={onSubmit} className="flex flex-col gap-5">
                      <div className="flex gap-5">
                        <input required name="firstName" type="text" placeholder="Prénom" className="w-full rounded-xl border border-[#d4af37]/30 bg-transparent px-4 py-3 text-sm text-[#e8e1d3] placeholder:text-[#a89b82] focus:border-[#d4af37] focus:outline-none focus:ring-1 focus:ring-[#d4af37]" />
                        <input required name="lastName" type="text" placeholder="Nom" className="w-full rounded-xl border border-[#d4af37]/30 bg-transparent px-4 py-3 text-sm text-[#e8e1d3] placeholder:text-[#a89b82] focus:border-[#d4af37] focus:outline-none focus:ring-1 focus:ring-[#d4af37]" />
                      </div>
                      <input required name="phone" type="tel" placeholder="Numéro de téléphone (WhatsApp)" className="w-full rounded-xl border border-[#d4af37]/30 bg-transparent px-4 py-3 text-sm text-[#e8e1d3] placeholder:text-[#a89b82] focus:border-[#d4af37] focus:outline-none focus:ring-1 focus:ring-[#d4af37]" />
                      <input required name="address" type="text" placeholder="Adresse complète" className="w-full rounded-xl border border-[#d4af37]/30 bg-transparent px-4 py-3 text-sm text-[#e8e1d3] placeholder:text-[#a89b82] focus:border-[#d4af37] focus:outline-none focus:ring-1 focus:ring-[#d4af37]" />
                      <input name="notes" type="text" placeholder="Indications supplémentaires pour le livreur (Optionnel)" className="w-full rounded-xl border border-[#d4af37]/30 bg-transparent px-4 py-3 text-sm text-[#e8e1d3] placeholder:text-[#a89b82] focus:border-[#d4af37] focus:outline-none focus:ring-1 focus:ring-[#d4af37]" />
