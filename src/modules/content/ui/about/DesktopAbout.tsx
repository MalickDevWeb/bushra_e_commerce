      ...
      <DesktopSidebarShell>
        ...
        <section className="relative w-full h-[220px] flex flex-col justify-center px-16 border-b border-[#d4af37]/20 shrink-0">
          <div className="absolute inset-0 z-0">
            ...
            <Image src="/images/hero_censer.jpg" alt="Background" fill priority sizes="(max-width: 1024px) 100vw, calc(100vw - 280px)" className="object-cover opacity-60 mix-blend-overlay object-right" />
          </div>
        ...
        <section className="px-16 py-12 flex gap-12 shrink-0">
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative w-[300px] h-[450px] rounded-[2rem] overflow-hidden border border-[#d4af37]/30 shadow-2xl">
              <Image src="/images/hero_censer.jpg" alt="Encensoir Bushra" fill sizes="300px" className="object-cover" />
