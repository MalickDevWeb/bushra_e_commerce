...
export default function OrangeMoneyConfiguration() {
  return (
    <AdminPageShell>
      <AdminPageHeader title="Configuration API Orange Money" description="Gérez l'intégration Orange Money Web Payment" action={<button className="px-4 py-2 bg-[#d4af37] text-[#0a0a0a] rounded-md font-semibold text-sm hover:bg-[#c59b32] transition-colors shadow-[0_0_15px_rgba(212,175,55,0.2)]">Sauvegarder les clés</button>} />
